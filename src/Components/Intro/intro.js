...
const Intro = () => {
  ...
  // Use inView to detect when the section is visible
  const isInView = useInView(contentRef, {
    once: false, // Important: set to false to trigger animations every time
    amount: 0.2, // Trigger when 20% of the element is in view
    fallback: true // Ensure it works even if IntersectionObserver isn't supported
  })
  ...
  const handleMouseMove = useCallback(
    (e) => {
      if (!introRef.current || !isDesktop) return
  ...
  // Memoize social links data to prevent unnecessary re-renders
  const socialLinks = [
    {
      icon: "bxl-linkedin",
  ...
  return (
    <section id="intro" ref={introRef}>
      ...
      <div className="intro-container" ref={contentRef}>
        <motion.div 
        ...
        >
          <div className="intro-left">
            ...
            <motion.p className="intro-bio" variants={itemVariants}>
              Transforming ideas into exceptional digital experiences. I specialize in creating modern, responsive web
            ...
            <motion.div className="intro-actions" variants={itemVariants}>
              ...
              <Link to="contact" spy={true} smooth={true} duration={500} offset={-80} className="btn btn-outline">
                Contact Me
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="intro-right">
            <div className="intro-image-wrapper">
              <motion.div
                ...
                style={{
                  transform: isDesktop
                    ? `perspective(1200px) rotateY(${mousePosition.x * 10}deg) rotateX(${-mousePosition.y * 10}deg)`
                    : "none",
