...
const Intro = () => {
  ...
  return (
    ...
    >
      {/* Conditionally render the circular image for mobile */}
      {!isDesktop && (
        <div className="imageContainer">
          <img src={bg} alt="Profile" className="mobileBg" />
        </div>
      )}
      ...
      <p className="introPara">
        I'm a passionate and dedicated Mern Stack Web Developer with a knack for
        solving complex problems and a love for crafting elegant and efficient web
        solutions.
      </p>
      <motion.div
    ...
    {/* Show the full image only for desktop */}
